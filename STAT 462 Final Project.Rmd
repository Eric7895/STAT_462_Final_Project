...
# Discussion
Several data visualization techniques were utilized for exploratory analysis of the data. The boxplots of BMI stratified by sex show that males have a higher BMI than females on average. The relationship between the variables BMI and age were also plotted in a scatterplot. There is no visible pattern or correlation in the data. The points are random and evenly distributed. 
